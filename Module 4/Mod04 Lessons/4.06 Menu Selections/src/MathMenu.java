...
public class MathMenu
{
    public static void main(String [] args)
    {
        ...
        {
        	System.out.println("You chose Q for quit. Ending program now...");
        }
        else
        {
             System.out.println("You did not choose a valid menu option!, please restart the program and choose a valid option");
        }
